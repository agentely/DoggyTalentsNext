...
public class Heeler2Model extends DogModel{

    public Heeler2Model(ModelPart box) {
        super(box);
	}
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = real_head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 12).addBox(-2.5F, -0.2055F, -1.0F, 5.0F, 2.0F, 2.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(-0.0044F, -0.8616F, 2.152F, -0.4363F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = real_head.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(29, 8).addBox(-2.0F, -0.5F, -0.4276F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.2511F, -0.2358F, -2.1724F, -0.0436F, 0.1745F, 0.0F));

		PartDefinition cube_r5 = real_head.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(12, 13).mirror().addBox(1.2F, -3.2422F, -4.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.0044F, 4.0097F, 0.0609F, 0.0F, 0.48F, 0.0F));

		PartDefinition cube_r6 = real_head.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(22, 11).mirror().addBox(0.0F, -0.5F, -0.3276F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.2423F, -0.2358F, -2.1724F, -0.0436F, -0.0873F, 0.0F));
